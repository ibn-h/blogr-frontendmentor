...
function Feature() {
  return (
    <section className="rounded-tr-[3rem] rounded-bl-[3rem] bg-[#3a3b59] bg-[url('src/assets/bg-pattern-circles.svg')] bg-[center_top] bg-no-repeat py-16 text-gray-50 md:rounded-tr-[6rem] md:rounded-bl-[6rem] md:bg-[-20%_80%] md:py-32">
